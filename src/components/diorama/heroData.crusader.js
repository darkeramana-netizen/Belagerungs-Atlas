  ...
  krak: {
    ...
    components: [
      ...
      },
      {
        ...
        points: [
          { x: 0, z: 10, r: 2.3, h: 11.5, plinthH: 1.2, plinthDrop: 0.62, plinthTopScale: 1.2, plinthBottomScale: 1.34, skirtH: 3.0, skirtTopScale: 1.34, skirtBottomScale: 1.54, hoarding: true, oriel: true, label: 'Torre Grande (Grosser Turm)', info: 'Der maechtigste Turm des Krak und letzter Rueckzugspunkt der Johanniter.' },
          { x: -9.51, z: 3.09, r: 2.0, h: 10.0, plinthH: 1.02, plinthDrop: 0.56, plinthTopScale: 1.2, plinthBottomScale: 1.34, skirtH: 2.8, skirtTopScale: 1.34, skirtBottomScale: 1.52, oriel: true, label: 'Suedwestturm (Waechterturm)', info: 'Einer der drei massiven Suedtuerme mit senkrechten Abwurfwinkeln auf Angreifer am Mauerfuss.' },
          ...
          { x: 9.51, z: 3.09, r: 1.9, h: 9.5, plinthH: 0.98, plinthDrop: 0.54, plinthTopScale: 1.2, plinthBottomScale: 1.34, skirtH: 2.7, skirtTopScale: 1.34, skirtBottomScale: 1.5, oriel: true, label: 'Suedostturm (Torre del Maestre)', info: 'Flankiert den Rampeneingang zum Innenhof und schliesst die starke Suedfront.' },
        ],
      ...
      {
        type: 'GABLED_HALL', x: 0.0, z: -5.5, w: 8.8, d: 3.5, h: 3.2, y: 8.14, roofH: 1.9, buttressPairs: 3, slitCount: 2, doorSide: 'front', doorW: 0.9, chimneyCount: 2,
      ...
      {
        type: 'GABLED_HALL', x: 4.9, z: -0.5, w: 2.9, d: 2.4, h: 3.8, y: 8.14, roofH: 1.55, slitCount: 1, doorSide: 'front', doorOffset: -0.2, porch: true,
      ...
      {
        type: 'GABLED_HALL', x: -2.8, z: 1.7, w: 3.5, d: 2.4, h: 2.5, y: 8.14, roofH: 1.15, doorSide: 'front', slitCount: 0,

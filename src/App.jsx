...
function WorldMap({castles,onSelect,selected}){
  ...
  return(
    <div style={{padding:"18px 20px"}}>
      ...
      {mapTab==="real"
        ? <RealWorldMap castles={filteredCastles} onSelect={onSelect} selected={selected}/>
...
Nach 5-9 Zügen bei guter Strategie: "**[GEFALLEN]**", bei schlechter: "**[GEHALTEN]**".`,
      ...
      let reply;
      if(!data){
        // Persönlichkeits-basierter Fallback
        ...
        reply=defPool&&Math.random()<0.5
          ?defPool[Math.floor(Math.random()*defPool.length)]
...
const CAMPAIGNS = [
  ...
  },
  {
    ...
    story:[
      "850 n.Chr.: Der Schwarze Bergfried steht seit Generationen. Heute Nacht nähert sich eine feindliche Vorhut.",
      "Castle Sorrow: Der Ordensrat tagt. Ein Spion wurde enttarnt — aber er hat bereits Pläne gestohlen.",
      "Gravecrest: Das Signalfeuer ist erloschen. Castle Sorrow sendet kein Zeichen. Du bist allein auf dem Berg.",
    ],
    choices:[
      // Kapitel 1: Schwarzer Bergfried
      {
        question:"Der Feind weiß nicht dass du ihn beobachtest. Greifst du die Vorhut an — oder lässt du sie passieren und alarmierst Castle Sorrow?",
        options:[
          {label:"⚔️ Vorhut vernichten", effect:"bonus", desc:"Dreißig Feinde fallen. Aber der Haupttrupp weiß nun wo du bist.", siegeBonus:0},
          {label:"🔥 Signalfeuer & warten", effect:"bonus", desc:"Castle Sorrow mobilisiert. Verstärkung trifft in zwei Tagen ein — der Bergfried hält.", siegeBonus:2},
          {label:"🕵️ Vorhut beschatten", effect:"bonus", desc:"Du folgst ihnen. Sie führen dich zum Hauptlager — und du kennst nun die Gesamtstärke.", siegeBonus:1},
        ],
      },
      // Kapitel 2: Castle Sorrow
      {
        question:"Der enttarnte Spion sitzt im Kerker. Er bietet an zu reden — gegen freies Geleit. Akzeptierst du?",
        options:[
          {label:"✅ Geleit gewähren & verhören", effect:"bonus", desc:"Er verrät den Angriffsplan. Du kannst die Verteidigung entsprechend ausrichten.", siegeBonus:2},
          {label:"🔒 Gefangen halten & foltern", effect:"risky", desc:"Er redet — aber langsam. Die Information kommt zu spät für optimale Vorbereitung.", siegeBonus:0},
          {label:"🎭 Geleit versprechen & brechen", effect:"risky", desc:"Er redet sofort alles. Aber das Wort des Ordens gilt fortan nichts mehr.", siegeBonus:1},
        ],
      },
      // Kapitel 3: Gravecrest
      {
        question:"Das Signalfeuer ist erloschen — Castle Sorrow kämpft. Du hast 80 Ritter. Greifst du den Feind im Rücken an oder hältst du Gravecrest?",
        options:[
          {label:"🏔️ Gravecrest halten", effect:"safe", desc:"Die Bergfestung hält. Aber Castle Sorrow fällt ohne deinen Entsatz.", siegeBonus:0},
          {label:"⚔️ Angriff im Rücken", effect:"risky", desc:"80 Ritter gegen 600. Drei Stunden Chaos — genug damit Castle Sorrow das Tor schließen kann.", siegeBonus:2},
          {label:"📯 Bote durch Feindeslinien", effect:"bonus", desc:"Ein einzelner Reiter schleicht sich durch. Castle Sorrow koordiniert den Gegenangriff.", siegeBonus:1},
        ],
      },
    ],
  },

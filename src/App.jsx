...
// SVG continent paths — generated from real lat/lon via equirectangular projection
// x = (lon+180)/360*1000, y = (90-lat)/180*500
const CONTINENT_PATHS = [
  // North America
  {d:"M 33 50 L 111 50 L 139 83 L 153 117 L 156 139 L 175 161 L 231 178 L 256 206 L 269 222 L 286 228 L 333 228 L 347 217 L 356 194 L 333 181 L 317 128 L 333 119 L 350 119 L 353 106 L 339 89 L 319 83 L 278 75 L 269 89 L 236 83 L 194 83 L 153 83 L 125 83 L 111 89 L 89 78 L 56 78 L 33 83 Z", fill:"rgba(52,78,35,0.65)"},
  // Greenland
  {d:"M 347 19 L 444 19 L 450 39 L 439 56 L 378 83 L 350 81 L 350 61 L 339 39 L 347 19 Z", fill:"rgba(52,78,35,0.42)"},
  // Iceland
  {d:"M 433 72 L 461 72 L 461 64 L 439 64 L 433 72 Z", fill:"rgba(52,78,35,0.45)"},
  // South America
  {d:"M 272 228 L 283 244 L 300 256 L 306 278 L 292 292 L 306 306 L 319 306 L 333 311 L 356 328 L 361 342 L 356 361 L 342 378 L 319 403 L 311 403 L 317 389 L 328 372 L 339 356 L 347 339 L 367 328 L 383 311 L 389 292 L 400 272 L 394 261 L 378 250 L 356 244 L 339 233 L 328 228 L 300 217 L 292 222 L 272 228 Z", fill:"rgba(65,90,32,0.62)"},
  // Europe main body
  {d:"M 472 150 L 483 147 L 500 147 L 508 147 L 514 131 L 528 128 L 539 125 L 556 125 L 569 133 L 583 133 L 600 133 L 611 144 L 600 133 L 583 122 L 567 117 L 556 111 L 539 100 L 528 97 L 514 92 L 522 83 L 514 78 L 522 72 L 544 56 L 578 53 L 589 56 L 578 69 L 561 83 L 569 97 L 561 106 L 539 103 L 528 100 L 522 89 L 514 94 L 500 108 L 489 108 L 483 111 L 494 117 L 500 122 L 494 128 L 489 128 L 478 128 L 472 128 L 472 139 L 475 144 L 472 150 Z", fill:"rgba(52,78,35,0.68)"},
  // British Isles
  {d:"M 474 97 L 483 94 L 492 94 L 497 100 L 494 108 L 486 111 L 478 111 L 474 106 L 474 100 Z", fill:"rgba(52,78,35,0.62)"},
  // Ireland
  {d:"M 466 103 L 474 103 L 474 97 L 466 97 L 466 103 Z", fill:"rgba(52,78,35,0.58)"},
  // Iberian Peninsula (Spain/Portugal — Alhambra at x=490 y=147)
  {d:"M 472 131 L 486 128 L 497 131 L 500 144 L 497 155 L 483 158 L 472 153 L 469 144 L 472 131 Z", fill:"rgba(52,78,35,0.66)"},
  // Italian Peninsula
  {d:"M 519 122 L 528 125 L 533 136 L 533 150 L 528 158 L 522 153 L 519 142 L 519 128 Z", fill:"rgba(52,78,35,0.62)"},
  // Africa — Carcassonne x=507 y=130 should be just above Africa's north edge y=147
  {d:"M 472 150 L 508 147 L 556 147 L 589 158 L 600 183 L 617 217 L 622 217 L 639 217 L 644 217 L 622 228 L 617 244 L 611 261 L 594 272 L 589 300 L 600 317 L 600 344 L 572 344 L 550 333 L 539 311 L 533 289 L 522 261 L 522 239 L 506 233 L 489 233 L 472 222 L 456 211 L 450 206 L 450 194 L 461 183 L 472 167 L 472 150 Z", fill:"rgba(88,68,26,0.62)"},
  // Mediterranean Sea (paint over top of Africa to create sea gap)
  {d:"M 472 150 L 508 148 L 533 148 L 556 148 L 583 152 L 600 152 L 600 158 L 578 160 L 556 158 L 533 153 L 511 153 L 497 148 L 483 150 L 472 153 Z", fill:"rgba(5,15,38,0.96)"},
  // Middle East (Turkey to Iran) — Krak x=601 y=153 on land
  {d:"M 569 133 L 600 147 L 617 147 L 633 144 L 650 144 L 667 142 L 683 136 L 689 133 L 683 128 L 667 125 L 650 122 L 633 119 L 617 117 L 600 117 L 583 117 L 569 122 L 569 133 Z", fill:"rgba(52,78,35,0.65)"},
  // Arabia + Mesopotamia (Babylon x=623 y=160 on land)  
  {d:"M 583 152 L 611 155 L 628 158 L 644 158 L 661 155 L 672 161 L 678 172 L 672 183 L 661 194 L 650 200 L 644 211 L 639 217 L 622 217 L 617 211 L 611 200 L 600 194 L 594 183 L 589 169 L 583 158 Z", fill:"rgba(100,78,26,0.60)"},
  // Asia main (Alamut x=641 y=139, Mehrangarh x=703 y=178 on land)
  {d:"M 556 111 L 578 106 L 600 106 L 622 108 L 644 108 L 667 111 L 689 111 L 711 106 L 733 106 L 756 108 L 778 111 L 806 106 L 828 108 L 850 111 L 872 111 L 889 117 L 894 128 L 878 133 L 856 133 L 839 133 L 822 133 L 806 136 L 783 139 L 756 139 L 733 133 L 711 131 L 694 133 L 678 136 L 661 133 L 644 136 L 628 139 L 611 144 L 594 144 L 578 144 L 561 139 L 556 133 L 556 122 L 556 111 Z", fill:"rgba(52,78,35,0.65)"},
  // India (Mehrangarh x=703 y=178 on land — top of India)
  {d:"M 672 158 L 694 155 L 717 158 L 728 169 L 733 183 L 728 200 L 717 211 L 706 219 L 694 219 L 683 208 L 672 194 L 667 181 L 667 169 L 672 158 Z", fill:"rgba(52,78,35,0.62)"},
  // SE Asia + Indochina (Angkor x=789 y=213 on land)
  {d:"M 756 150 L 778 155 L 800 161 L 811 183 L 811 206 L 817 219 L 828 225 L 833 211 L 822 194 L 822 178 L 822 169 L 828 164 L 817 158 L 800 155 L 789 150 L 772 147 L 756 150 Z", fill:"rgba(52,78,35,0.60)"},
  // Japan (Himeji x=874 y=153 on land)
  {d:"M 856 136 L 869 139 L 878 147 L 883 158 L 878 167 L 867 169 L 856 161 L 850 150 L 850 142 L 856 136 Z", fill:"rgba(52,78,35,0.62)"},
  // China coast / Korea
  {d:"M 856 119 L 867 122 L 872 131 L 861 136 L 850 131 L 850 122 Z", fill:"rgba(52,78,35,0.55)"},
  // Australia
  {d:"M 817 311 L 828 306 L 850 289 L 867 283 L 878 289 L 883 300 L 889 300 L 894 278 L 900 289 L 917 311 L 928 322 L 928 339 L 911 356 L 889 356 L 872 350 L 850 344 L 822 339 L 817 328 L 817 311 Z", fill:"rgba(88,68,26,0.52)"},
];
    ...
    <div style={{position:"relative",userSelect:"none"}}>
      ...
      <div style={{position:"relative",background:"rgba(4,12,24,0.95)",borderRadius:"8px",
        ...
        <svg ref={svgRef} viewBox={`0 0 ${vw} ${vh}`} style={{width:"100%",display:"block"}}>
          ...
          <rect x="0" y="0" width="1000" height="28" fill="rgba(200,220,235,0.18)"/>
          <rect x="0" y="0" width="1000" height="12" fill="rgba(210,228,240,0.28)"/>
          {/* Antarctic ice cap (south pole) */}
          <rect x="0" y="472" width="1000" height="28" fill="rgba(200,220,235,0.18)"/>
          <rect x="0" y="488" width="1000" height="12" fill="rgba(210,228,240,0.28)"/>

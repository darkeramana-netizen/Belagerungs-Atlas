...
const LEXIKON_OFFLINE = {
  ...
  // Persönliche Burg
  schwarzer_bergfried:["Ursprünglich ca. 800–850 als Wachturm errichtet — noch vor der Gründung des Ordo Custodum Sorrowland selbst.","Das Motto: 'In silentio vigilamus' — Im Schweigen wachen wir. Der Schwarze Bergfried verkörpert es: massiv, kompakt, schweigsam.","Hier lagert das Archiv des Ordens — Jahrhunderte an Wissen und Geheimnissen. Die Ritter sterben eher als es preiszugeben.","Der Turm ist letzter Rückzugspunkt des Ordenssystems. Erst wenn Castle Sorrow und Gravecrest fallen, wird er aktiv verteidigt.","Das Wappen zeigt diesen Turm in zwei Varianten: detailliertes Siegelwappen für Dokumente, vereinfachter schwarzer Turm für Schilde und Banner."],
...
{id:"schwarzer_bergfried",name:"Schwarzer Bergfried",sub:"Spirituelles Zentrum des Ordens",era:"ca. 800–850",year:825,loc:"Sorrowland",type:"real",epoch:"Mittelalter",region:"europa",icon:"⬛",
 theme:{bg:"#060608",accent:"#8a8a9a",glow:"rgba(100,100,130,0.18)"},
 ratings:{walls:85,supply:65,position:92,garrison:55,morale:99},
 desc:"Die älteste Festung des Ordo Custodum Sorrowland. Ursprünglicher Wachturm, spirituelles Zentrum, Archiv und letzter Rückzugspunkt. Das Wappen des Ordens trägt sein Bild.",
 history:"Ca. 800–850 als Wachturm errichtet — noch vor der Gründung des Ordens. Als der Ordo Custodum Sorrowland ca. 870–900 entstand, wurde der Turm zum Ordenssymbol. Hier lagern die wichtigsten Relikte und das Archiv des Ordens. Das Motto des Ordens: 'In silentio vigilamus' — Im Schweigen wachen wir.",
 verdict:"Kein Angreifer hat je alle drei Burgen des Ordens gleichzeitig isoliert. Solange Gravecrest und Castle Sorrow stehen, ist der Schwarze Bergfried uneinnehmbar.",
 zones:[
   {id:"bt",l:"Schwarzer Bergfried",x:50,y:35,r:16,c:"#8a8a9a",a:6,d:"Massiver Bergfried mit extrem dicken Mauern, wenigen Fenstern, schwer zugänglichem Eingang. Die Ordensreliquien lagern hier."},
   {id:"ar",l:"Archiv des Ordens",x:30,y:38,r:9,c:"#aa9944",a:5,d:"Jahrhunderte an Wissen, Karten, Geheimnissen. Unzerstörbar soll es sein — die Ritter sterben eher als es preiszugeben."},
   {id:"fp",l:"Felsplateau",x:50,y:58,r:36,c:"#666677",a:5,d:"Drei Seiten senkrecht abfallend. Teil des koordinierten Signalsystems mit Castle Sorrow und Gravecrest."},
   {id:"sg",l:"Signalfeuer",x:78,y:25,r:8,c:"#cc8833",a:3,d:"Feuerzeichen nachts, Rauch tagsüber. Direkte Verbindung zu Gravecrest und Castle Sorrow."},
   {id:"sp",l:"Einziger Pfad ⚠",x:50,y:92,r:9,c:"#cc4444",a:1,d:"Der einzige Zugang. Wird von Gravecrest aus überwacht — kein Angreifer kann ihn unbemerkt nutzen."},
 ],
 strengths:["Spirituelles Zentrum — Moral der Ritter unerschütterlich","Koordiniertes Signalsystem mit 2 weiteren Burgen","Extremdicke Mauern, wenige Angriffspunkte","Archiv und Relikte geben dem Orden besonderen Verteidigungswillen"],
 weaknesses:["Kleine Garnison — kein eigenständiger Großkampf möglich","Versorgung nur über den Pfad","Isoliert wenn Gravecrest und Castle Sorrow fallen"],
 attackTips:["Zuerst Gravecrest nehmen — Pfadüberwachung eliminieren","Signalsystem stören — alle drei gleichzeitig angreifen","Archiv als Verhandlungsmasse nutzen — Ritter könnten kapitulieren um es zu schützen"],
 siegeCtx:"Der Orden hat alle drei Burgen verloren bis auf den Bergfried. Die letzten 40 Ritter halten das Archiv. Ein Feind mit 800 Mann steht am Fuß des Felsens.",
 defender:"Großmeister des Ordo Custodum Sorrowland"},

{id:"castle_sorrow",name:"Castle Sorrow",sub:"Hauptsitz des Ordens",era:"10.–11. Jh.",year:1000,loc:"Sorrowland",type:"real",epoch:"Mittelalter",region:"europa",icon:"🏰",
 theme:{bg:"#0a080e",accent:"#aa6688",glow:"rgba(150,80,120,0.15)"},
 ratings:{walls:90,supply:92,position:82,garrison:88,morale:90},
 desc:"Ordenshauptquartier, Hauptgarnison, Waffenlager, Verwaltungszentrum. Größte der drei Burgen — und erste Verteidigungslinie gegen jeden Angriff.",
 history:"Im 10.–11. Jahrhundert als Ordenshauptquartier errichtet. Später im 15.–16. Jahrhundert um einen Kanonen-Bastionsturm erweitert — eine der ersten Anpassungen an Schwarzpulverwaffen in der Region. Hält den Hauptangriff auf, während Gravecrest Verstärkung sammelt.",
 verdict:"Wer Castle Sorrow nimmt, hat den Orden militärisch enthauptet. Aber ohne Gravecrest und Schwarzen Bergfried ist der Sieg nicht vollständig.",
 zones:[
...
{id:"gravecrest",name:"Gravecrest",sub:"Bergfestung & Rückzugspunkt",era:"12. Jh.",year:1150,loc:"Sorrowland",type:"real",epoch:"Mittelalter",region:"europa",icon:"⛰️",
 theme:{bg:"#080c0a",accent:"#7aaa88",glow:"rgba(100,160,120,0.15)"},
 ratings:{walls:92,supply:72,position:97,garrison:68,morale:92},
 desc:"Hoch oben auf einem Berg, nur ein schmaler Zugangspfad. Militärischer Sammelpunkt, Rückzugsfestung, strategische Höhenposition. Ähnlich Hochosterwitz in Kärnten.",
 history:"Im 12. Jahrhundert als strategische Höhenposition erbaut. Gravecrest sammelt Verstärkung wenn Castle Sorrow unter Druck steht, und überwacht den einzigen Pfad zum Schwarzen Bergfried. Fast unmöglich zu stürmen — ideal für Entsatzarmeen.",
 verdict:"Solange Gravecrest steht, kann der Orden sich regenerieren. Kein Feind kann den Schwarzen Bergfried einnehmen ohne zuerst Gravecrest zu kontrollieren.",
 zones:[
...
const CAMPAIGNS = [
  {
    ...
    story:[
      "1191: Du landest mit dem Kreuzzug in Akkon. Die Stadt ist der wichtigste Hafen des Heiligen Landes.",
      "Durch die Levante ziehend erreichst du Masada — ein Zeugnis jüdischen Widerstands seit Jahrhunderten.",
      "Konstantinopel: Das Herz des byzantinischen Reichs. Hier entscheidet sich das Schicksal des Ostens.",
      "Rhodos: Die Johanniter haben hier eine uneinnehmbare Basis gegen osmanische Expansion gebaut.",
      "Ziel: Der Krak des Chevaliers — 130 Jahre uneingenommen. Kannst du bestehen wo so viele scheiterten?",
    ],
  },
  {
    id:"sorrowland_order",
    name:"Der Ordo Custodum",
    icon:"⬛",
    desc:"Erlebe die Geschichte des Ordo Custodum Sorrowland — vom ersten Wachturm bis zur finalen Belagerung.",
    era:"9.–14. Jahrhundert",
    difficulty:"schwer",
    castles:["schwarzer_bergfried","castle_sorrow","gravecrest"],
    story:[
      "850 n.Chr.: Der Schwarze Bergfried wird errichtet — ein einsamer Wachturm. Der Orden ist noch nicht geboren.",
      "Jahrzehnte vergehen. Aus dem Wachturm wird ein Symbol. Der Ordo Custodum Sorrowland entsteht.",
      "Castle Sorrow erhebt sich als Hauptquartier. Der Orden wächst, expandiert, verteidigt die Grenzen.",
      "Gravecrest — die Bergfestung — komplettiert das Dreieck. Das Signalfeuer-System ist perfekt.",
      "Die finale Prüfung: Ein mächtiger Feind greift alle drei gleichzeitig an. Hält das System?",
    ],
  },
  {
    id:"edwards_conquest",
    ...
    icon:"👑",
    desc:"Edward I. bezwang Wales mit einem Ring aus Burgen. Belagere sie der Reihe nach — von Dover bis Beaumaris.",
    era:"13.–14. Jahrhundert",
    difficulty:"leicht",
    castles:["dover","caernarvon","harlech","beaumaris","bodiam"],
    story:[
      "1265: Dover — Schlüssel zu England. Ohne diesen Hafen kommt keine Verstärkung aus Frankreich.",
      "Wales: Caernarvon erhebt sich als Symbol englischer Macht. Die Waliser brennen vor Wut.",
      "Harlech: 50 Mann halten diese Burg 7 Jahre. Was macht eine Burg wirklich uneinnehmbar?",
      "Beaumaris: Die geometrisch perfekteste Burg der Welt. Nie fertiggestellt, nie belagert.",
      "Bodiam: Ein englisches Herrenhaus das wie eine Burg aussieht — oder eine Burg die wie ein Herrenhaus aussieht?",
    ],
  },
  {
    id:"fall_of_fantasy",
    ...
    icon:"✦",
    desc:"Mittelerde in der größten Krise — von Gondolin bis Barad-dûr, die tragischsten Belagerungen der Fantasy.",
    era:"Erstes bis Drittes Zeitalter",
    difficulty:"legendär",
    castles:["gondolin","minas_tirith","helmsdeep","isengard","barad_dur"],
    story:[
      "Gondolin: Die verborgenste Stadt Mittelerdes. Kein Feind fand sie je — bis Maeglin den Weg zeigte.",
      "Helms Klamm: 300 Männer gegen 10.000 Uruk-hai. Der Drain ist die einzige Schwäche — und sie finden ihn.",
      "Isengard: Sarumans Industriefestung. Unzerstörbar durch Waffen — aber Ents sind keine Waffen.",
      "Minas Tirith: Sieben Ringe, eine Stadt. Der Nazgûl-König bricht das Tor — aber Éowyn bricht ihn.",
      "Barad-dûr: Saurons Turm aus purem Willen. Die einzige Waffe: ein kleiner Hobbit und ein Feuerberg.",
    ],
  },
];

function Campaign({castles,onSelect,addScore}){
  ...
  const nextStep=()=>{
    if(step<activeCampaign.castles.length-1){
      setStep(s=>s+1);
      setShowIntro(true);
    } else {
      // Campaign complete
  ...
  const recordResult=(won)=>{
    ...
    if(addScore) addScore(activeCampaign.castles[step],won,won?8:3);
    nextStep();
  };
  ...
  if(activeCampaign){
    ...
    return(
      <div style={{padding:"18px 20px",maxWidth:"700px"}}>
        {/* Campaign progress bar */}
        <div style={{marginBottom:"16px"}}>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"8px"}}>
            <div style={{fontSize:"14px",fontWeight:"bold",color:"#f0e6cc"}}>{activeCampaign.icon} {activeCampaign.name}</div>
            <div style={{fontSize:"12px",color:"#8a7a58"}}>Kapitel {step+1} / {activeCampaign.castles.length}</div>
          </div>
          <div style={{height:"4px",background:"rgba(255,255,255,0.05)",borderRadius:"2px",overflow:"hidden"}}>
            <div style={{height:"100%",width:`${((step)/activeCampaign.castles.length)*100}%`,
              background:`linear-gradient(90deg,${currentCastle.theme.accent},#c9a84c)`,
          ...
          <div style={{display:"flex",gap:"4px",marginTop:"6px"}}>
            {activeCampaign.castles.map((id,i)=>{
              const res=results[i];
              return(
                <div key={id} style={{flex:1,height:"3px",borderRadius:"2px",
                  background:res?(res.won?"#6aaa50":"#cc4444"):i===step?"#c9a84c":"rgba(255,255,255,0.06)"}}/>
              );
            })}
          </div>
        </div>
        ...
        {/* Story intro */}
        {showIntro&&(
          <div style={{padding:"16px 18px",background:`linear-gradient(135deg,${currentCastle.theme.bg},rgba(8,5,2,0.98))`,
            border:`1px solid ${currentCastle.theme.accent}33`,borderLeft:`4px solid ${currentCastle.theme.accent}`,
            borderRadius:"6px",marginBottom:"16px",animation:"fadeIn 0.3s ease"}}>
            <div style={{fontSize:"11px",color:currentCastle.theme.accent,letterSpacing:"2px",marginBottom:"8px"}}>
              📖 KAPITEL {step+1} — {currentCastle.name.toUpperCase()}
            </div>
            <p style={{fontSize:"14px",color:"#c0b080",lineHeight:1.85,margin:"0 0 12px",fontStyle:"italic"}}>
              "{activeCampaign.story[step]}"
            </p>
            <div style={{display:"flex",gap:"10px",alignItems:"center"}}>
              <span style={{fontSize:"24px"}}>{currentCastle.icon}</span>
              <div>
                <div style={{fontSize:"14px",fontWeight:"bold",color:"#f0e6cc"}}>{currentCastle.name}</div>
                <div style={{fontSize:"11px",color:currentCastle.theme.accent}}>{currentCastle.sub} · {currentCastle.era}</div>
              </div>
            </div>
            <div style={{display:"flex",gap:"8px",marginTop:"14px"}}>
              <button onClick={()=>{setShowIntro(false);onSelect(currentCastle);}}
                style={{flex:1,padding:"9px",background:`${currentCastle.theme.accent}18`,
                  border:`1px solid ${currentCastle.theme.accent}44`,color:currentCastle.theme.accent,
                  borderRadius:"4px",cursor:"pointer",fontSize:"12px",letterSpacing:"1px"}}>
                🗺️ BURG ERKUNDEN
              </button>
              <button onClick={()=>setShowIntro(false)}
                style={{flex:1,padding:"9px",background:"rgba(255,255,255,0.04)",
                  border:"1px solid rgba(255,255,255,0.08)",color:"#8a7a58",
                  borderRadius:"4px",cursor:"pointer",fontSize:"12px",letterSpacing:"1px"}}>
                ⚔️ DIREKT BELAGERN
              </button>
            </div>
        ...
        {!showIntro&&(
          <div style={{animation:"fadeIn 0.2s ease"}}>
            {/* Quick siege result buttons */}
            <div style={{padding:"14px 16px",background:"rgba(0,0,0,0.3)",border:"1px solid rgba(255,255,255,0.05)",borderRadius:"6px",marginBottom:"12px"}}>
              <div style={{fontSize:"12px",color:"#8a7a58",letterSpacing:"1px",marginBottom:"10px"}}>
                Wie verlief deine Belagerung von <strong style={{color:currentCastle.theme.accent}}>{currentCastle.name}</strong>?
              </div>
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"8px"}}>
                <button onClick={()=>recordResult(true)}
                  style={{padding:"12px",background:"rgba(30,80,20,0.2)",border:"1px solid rgba(50,140,30,0.3)",
                    color:"#6aaa50",borderRadius:"5px",cursor:"pointer",fontSize:"13px",
                    transition:"all 0.15s"}}>
                  ✅ Eingenommen
                </button>
                <button onClick={()=>recordResult(false)}
                  style={{padding:"12px",background:"rgba(80,20,10,0.2)",border:"1px solid rgba(150,40,20,0.3)",
                    color:"#cc5533",borderRadius:"5px",cursor:"pointer",fontSize:"13px",
                    transition:"all 0.15s"}}>
                  ❌ Gehalten
                </button>
              </div>
            ...
            <button onClick={()=>setShowIntro(true)}
              style={{width:"100%",padding:"7px",background:"transparent",
                border:"1px solid rgba(255,255,255,0.05)",color:"#5a4a28",
        ...
        {results.length>0&&(
          <div style={{marginTop:"12px",display:"flex",gap:"5px",flexWrap:"wrap"}}>
            {results.map((r,i)=>{
              ...
              return(
                <div key={i} style={{padding:"4px 8px",background:r.won?"rgba(30,80,20,0.15)":"rgba(80,20,10,0.15)",
                  border:`1px solid ${r.won?"rgba(50,140,30,0.25)":"rgba(150,40,20,0.25)"}`,
                  borderRadius:"4px",fontSize:"11px",color:r.won?"#6aaa50":"#cc5533",
                  display:"flex",gap:"4px",alignItems:"center"}}>
  ...
  return(
    <div style={{padding:"18px 20px"}}>
      <div style={{fontSize:"16px",fontWeight:"bold",color:"#f0e6cc",marginBottom:"6px"}}>📖 Kampagnenmodus</div>
      <div style={{fontSize:"13px",color:"#8a7a58",marginBottom:"18px",lineHeight:1.7}}>
        Erlebe historische Festungen als zusammenhängende Geschichte — jede Burg ein Kapitel.
      </div>
      ...
      <div style={{display:"flex",flexDirection:"column",gap:"10px"}}>
        {CAMPAIGNS.map(camp=>{
          ...
          return(
            <div key={camp.id} style={{padding:"16px 18px",background:"rgba(255,255,255,0.02)",
                ...
                <div style={{flex:1}}>
                  <div style={{display:"flex",gap:"8px",alignItems:"center",marginBottom:"3px"}}>
                    ...
                    <div style={{padding:"2px 7px",borderRadius:"10px",fontSize:"10px",
                      ...
                      color:diffColor[camp.difficulty]}}>
                      {camp.difficulty}
                    </div>
                  ...
                  <div style={{fontSize:"12px",color:"#8a7a58",marginBottom:"8px",lineHeight:1.7}}>{camp.desc}</div>
                  <div style={{fontSize:"11px",color:"#6a5a38",marginBottom:"8px"}}>⏳ {camp.era}</div>
                  <div style={{display:"flex",gap:"5px",flexWrap:"wrap"}}>
                    {campCastles.map(c=>(
                      <span key={c.id} style={{fontSize:"14px"}} title={c.name}>{c.icon}</span>
                    ))}
                    <span style={{fontSize:"11px",color:"#5a4a28",alignSelf:"center",marginLeft:"4px"}}>
                      {camp.castles.length} Burgen
                    </span>
                  </div>
                </div>
                <div style={{fontSize:"20px",color:"#3a2a14",flexShrink:0}}>›</div>
              </div>
            </div>
          );
        })}
...
export default function App(){
  ...
  const [playStats,setPlayStats]=useState(()=>{
    try{ return JSON.parse(localStorage.getItem('bAtlas_stats')||'{"sieges":0,"wins":0,"totalDays":0,"favCastle":null}'); }catch{return {sieges:0,wins:0,totalDays:0,favCastle:null};}
  });
  ...
  const addScore=useCallback((castleId,won,r)=>{
    ...
    setPlayStats(ps=>{
      const next={...ps,sieges:ps.sieges+1,wins:ps.wins+(won?1:0),totalDays:ps.totalDays+(r||0)};
      try{localStorage.setItem('bAtlas_stats',JSON.stringify(next));}catch{}
      return next;
    });
  },[]);
  ...
  const NAVTABS=[{id:"overview",l:"🏰 Übersicht"},{id:"worldmap",l:"🌍 Karte"},{id:"detail",l:`${sel.icon} ${sel.name.split(" ")[0]}`},{id:"campaign",l:"📖 Kampagne"},{id:"tournament",l:"🗡️ Turnier"},{id:"build",l:"🏗️ Bauen"},{id:"timeline",l:"📅 Zeit"},{id:"globalstats",l:"📊 Atlas"},{id:"highscores",l:"🏆 Scores"}];
  ...
  return(
    <div style={{minHeight:"100vh",background:"#060504",color:"#e8dcc8",fontFamily:"'Palatino Linotype','Book Antiqua',Georgia,serif",display:"flex",flexDirection:"column"}}>
      ...
      {/* ── HIGHSCORES ── */}
      {tab==="campaign"&&<div style={{flex:1,overflowY:"auto"}}><Campaign castles={CASTLES} onSelect={go} addScore={addScore}/></div>}
